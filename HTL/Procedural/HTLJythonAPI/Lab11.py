...
def buildGame(Game):
    ...
    Game.setCountdownFrom(1)
    Game.setScoreToWin(1)
    Game.setSpeedyTimeBetweenSpellcasts(1.0)
    Game.setMedicTimeBetweenSpellcasts(3.0)
    # setMedicWizardHealthAdjust(10.0);
    Game.setMedicWizardHealthAdjust(-10.0); # if negative, reduce health
    Game.setSpeedyWizardSpeedBoostDuration(1.0)
    # setSpeedyWizardSpeedBoostMultipler(3.0);
    Game.setSpeedyWizardSpeedBoostMultipler(-3.0);  # if negative, walker goes
                                                    # backwards
